...
| M2/SKIN preview | Native mesh/UV, bounded discovery, base-geoset filtering, SKIN material-unit and M2 texture-lookup parsing, per-submesh embedded BLP assignment, DBC-driven playable-race base-skin selection with explicit provenance | Remaining CharSections layers and replaceable slots, multi-pass shaders, equipment, animation, particles, export |
