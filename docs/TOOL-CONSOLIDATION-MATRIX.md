...
|---|---|---|
| DBC WDBC editing | Native multi-document virtual editor, decoded fields, undo/redo, bulk clone, layer/promotion services, full-version WoWDBDefs DBD parsing/audit with WDBX cross-checking, and atomic schema-aware CSV/JSONL/JSON export with decoded strings, selected columns/keys, and stable/virtual identity metadata | DB2 containers, structured import, additional domain workspaces, and broader effective DBC+SQL views |
