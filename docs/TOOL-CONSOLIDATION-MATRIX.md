...
|---|---|---|
| DBC WDBC editing | Native multi-document virtual editor, decoded fields, undo/redo, bulk clone, layer/promotion services, and full-version WoWDBDefs DBD parsing/audit with WDBX cross-checking | DB2 containers, structured import/export, domain workspaces, effective DBC+SQL view |
