...
| Modern M2/WMO conversion | Native same-window recursive drag/drop inspection, MD20/MD21/WMO chunk and dependency reports, atomic immutable SHA-256-verified workspaces, movable report reopening, and compatible WotLK M2/SKIN preview | Implement and validate structure-by-structure modern-to-WotLK output writers without silently discarding unsupported data |
