...
| Server & SQL | Shared automatic WSL/local detection, schema verification, native lifecycle controls, paged full-row SQL Studio, confirmed query/write path, and persistent cross-table favorites | Visual joins/relations, insert/delete designers, export/import, broader adapters, deployment rollback, and remaining HeidiSQL parity |
