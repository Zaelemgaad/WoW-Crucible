...
|---|---|---|
| DBC WDBC editing | Native multi-document virtual editor, decoded fields, undo/redo, bulk clone, layer/promotion services, full-version WoWDBDefs DBD parsing/audit with WDBX cross-checking, atomic schema-aware CSV/JSONL/JSON export, and preview-first keyed structured import with decoded string re-interning, explicit append, stable/virtual identity safety, and stale-plan refusal | DB2 containers, additional domain workspaces, and broader effective DBC+SQL views |
