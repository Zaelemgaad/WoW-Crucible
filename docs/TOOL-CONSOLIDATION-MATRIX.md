...
| WMO/ADT/WDT/WDL/maps | Native same-window and CLI WotLK ADT/WDT/WDL inspection with bounded chunk validation, WDT/WDL 64×64 occupancy, ADT 16×16 MCNK area/holes/MCVT height decoding, referenced asset inventory, and a responsive clickable height-colored grid; recursive ADT/WDT asset closure already feeds patch manifests | Terrain height/texture/water/object editing, WMO rendering, multi-tile projects, minimap/horizon regeneration, UID/zone/light tools, 3D preview, and validated patch closure |
