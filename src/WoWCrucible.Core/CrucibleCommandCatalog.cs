...
public static class CrucibleCommandCatalog
{
    ...
    [
        ...
        Command("workspace.sql", "SQL Studio", "Workspace", "Browse every schema/table/field, edit exact rows, and manage favorites, queries, columns, indexes, objects, users, and imports.", "heidi heidisql database mysql query full sql favorite row table schema column alter modify rename clone procedure trigger view users grants", "Ctrl+K, then SQL"),
