...
public static class CrucibleCommandCatalog
{
    ...
    [
        ...
        Command("workspace.projects", "Projects, shared IDs & playable classes", "Workspace", "Create portable content projects, reserve collision-checked IDs, and build dependency-aware playable-class DBC/SQL/MPQ bundles.", "project registry allocator allocation occupied collision custom ids fusion content class clone playable chrclasses charbaseinfo charstartoutfit"),
