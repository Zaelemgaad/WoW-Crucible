...
public static class CrucibleCommandCatalog
{
    ...
    [
        ...
        Command("workspace.gameobjects", "Gameobjects", "Workspace", "Create and edit all gameobject types, displays, spawns, loot, quest links, and bulk model imports.", "gameobject_template gob generator bulk m2 wmo object chest door fishing spawn display"),
