...
public static class CrucibleCommandCatalog
{
    ...
    [
        ...
        Command("workspace.client", "Client workshop", "Workspace", "Index clients, inspect effective archive layers, plan fusion, and publish hash-bound player releases with optional groups and exact rollback.", "client data folder patch layers fusion extract index cache deploy launcher distribution updater release channel optional package ownership rollback amaroth"),
