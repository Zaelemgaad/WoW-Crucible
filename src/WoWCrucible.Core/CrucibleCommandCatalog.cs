...
public static class CrucibleCommandCatalog
{
    ...
    [
        ...
        Command("workspace.server", "Server & SQL", "Workspace", "Detect and control a server, recover legacy SQL edits through explicit cross-core schema bridges and exact dependency closure, and plan stale-safe deployment.", "server core worldserver authserver mysql wsl config connection start stop restart deploy legacy recovery synchronize dependency closure cross schema bridge translation adapter rename default drop remap rollback"),
