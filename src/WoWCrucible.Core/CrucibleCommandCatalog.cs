...
public static class CrucibleCommandCatalog
{
    ...
    [
        ...
        Command("workspace.textures", "Texture lab", "Workspace", "Inspect, decode, paint exact RGBA channels, prove compression loss, encode, validate, and preview BLP textures and mipmaps.", "blp png dxt texture converter alpha rgba channel brush paint compression loss mae rmse psnr difference mipmaps image"),
