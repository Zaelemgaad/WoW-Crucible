...
public static class CrucibleCommandCatalog
{
    ...
    [
        ...
        Command("workspace.mpq", "MPQ & CASC archives", "Workspace", "Browse and extract MPQ/CASC sources; create, update, merge, validate, and deploy small MPQ patches.", "mpq casc casclib explorer editor stormlib archive patch merge merger extract parallel workers fast list tree manifest drag drop later client"),
