...
public static class CrucibleCommandCatalog
{
    ...
    [
        ...
        Command("workspace.textures", "Texture lab", "Workspace", "Inspect, decode, paint, compose, transform, prove compression loss, encode, validate, and find the exact M2/WMO/map consumers of BLP textures.", "blp png dxt texture converter alpha rgba channel brush paint compose layers blend material opacity offset mask luminance scale tint transform compression loss mae rmse psnr difference mipmaps image where used usage consumer reverse dependency reference model wmo adt wdt provenance"),
