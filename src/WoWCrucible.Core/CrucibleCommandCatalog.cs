...
public static class CrucibleCommandCatalog
{
    ...
    [
        ...
        Command("workspace.pets", "Pets & companions", "Workspace", "Edit pet data, bulk-copy/scale complete level curves, and visually compare family growth across every numeric stat.", "pet companion minipet summon tame levelstats level curve growth scale compare graph family pet_levelstats pet_name_generation spell_pet_auras"),
