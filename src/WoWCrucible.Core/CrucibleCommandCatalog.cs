...
public static class CrucibleCommandCatalog
{
    ...
    [
        ...
        Command("workspace.cache", "Client cache tables", "Workspace", "Inspect, search, and export WDB cache records with exact schemas or bounded raw fallback.", "wdb adb cache converter parser creaturecache itemcache questcache wowparser csv jsonl"),
