...
public static class CrucibleCommandCatalog
{
    ...
    [
        ...
        Command("workspace.textures", "Texture lab", "Workspace", "Inspect, decode, paint exact RGBA channels, compose ordered material layers, transform through masks, prove compression loss, encode, validate, and preview BLP textures and mipmaps.", "blp png dxt texture converter alpha rgba channel brush paint compose layers blend material opacity offset mask luminance scale tint transform compression loss mae rmse psnr difference mipmaps image"),
