...
public static class CrucibleCommandCatalog
{
    ...
    [
        ...
        Command("workspace.conversion", "Modern asset conversion", "Workspace", "Inspect modern M2/WMO assets and publish immutable, path-preserving, validated downgrade payloads.", "multiconverter legion cata modern port downgrade m2 wmo conversion batch payload client paths listfile auto detect filedataid ldv1"),
