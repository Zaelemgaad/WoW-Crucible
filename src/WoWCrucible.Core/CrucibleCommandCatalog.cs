...
public static class CrucibleCommandCatalog
{
    ...
    [
        ...
        Command("workspace.items", "Items & sets", "Workspace", "Audit acquisition paths, safely synchronize SQL with Item.dbc, create or clone items, edit complete rows, tooltips, displays, and item sets.", "item_template item dbc sync clientitem wmv weapon armor loot cut unused unobtainable acquisition favorite set heidi easy editor npc equipment"),
        ...
        Command("workspace.sql", "SQL Studio", "Workspace", "Browse every schema/table/field, edit exact rows, and manage favorites, queries, columns, indexes, constraints, objects, users, and imports.", "heidi heidisql database mysql query full sql favorite row table schema column alter modify rename clone foreign key check constraint procedure trigger view users grants", "Ctrl+K, then SQL"),
