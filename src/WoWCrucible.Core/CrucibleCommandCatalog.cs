...
public static class CrucibleCommandCatalog
{
    ...
    [
        ...
        Command("workspace.pets", "Pets & companions", "Workspace", "Edit pet level stats, bulk-copy and scale complete level curves, generated/localized names, spell aura mappings, and related references.", "pet companion minipet summon tame levelstats level curve growth scale pet_levelstats pet_name_generation spell_pet_auras"),
