...
internal sealed class AssetComparisonWindow : Window
{
    ...
    private Control BuildLayout()
    {
        ...
        var middleHeader = new StackPanel { Spacing = 8, Margin = new Thickness(10, 10, 10, 4), Children = { _folderTitle, new TextBlock { Text = "Every PNG directly in this content directory is shown from archive patches and Loose content. Filenames do not need to match.", TextWrapping = TextWrapping.Wrap, Foreground = Brush.Parse("#8793A7"), FontSize = 11 }, new Grid { ColumnDefinitions = new("*,Auto"), ColumnSpacing = 8, Children = { _fileSearch, WithColumn(_sourceFilter, 1) } } } };
