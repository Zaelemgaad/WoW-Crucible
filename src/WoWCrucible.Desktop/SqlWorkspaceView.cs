...
internal sealed class SqlWorkspaceView : UserControl, IDisposable
{
    ...
    private void SelectRow()
    {
        ...
        if (_page.Table is "item_template" or "creature_template" or "gameobject_template" or "quest_template") { var guided = AccentButton("Open decoded editor"); guided.Click += (_, _) => GuidedEditRequested?.Invoke(this, new(_page.Table, _selectedRow.Values)); actions.Children.Add(guided); }
