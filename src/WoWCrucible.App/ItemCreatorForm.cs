...
internal sealed class ItemCreatorForm : Form
{
    ...
    private ItemDraft Draft() => new(
        ...
        Selected(_stat1), (int)_statValue1.Value, Selected(_stat2), (int)_statValue2.Value);
