...
internal sealed class SettingsForm : Form
{
    ...
    {
        Text = "WoW Crucible Paths"; Width = 850; Height = 385; StartPosition = FormStartPosition.CenterParent;
        ...
        var table = new TableLayoutPanel { Dock = DockStyle.Fill, Padding = new(12), ColumnCount = 3, RowCount = 7 };
        ...
        table.Controls.Add(new Label { Text = "Client Wow.exe:", AutoSize = true, Anchor = AnchorStyles.Left }, 0, 2);
        table.Controls.Add(_clientExecutable, 1, 2); table.Controls.Add(BrowseExecutable(_clientExecutable), 2, 2);
        table.Controls.Add(new Label { Text = "WotLK schema XML:", AutoSize = true, Anchor = AnchorStyles.Left }, 0, 3);
        table.Controls.Add(_schema, 1, 3); table.Controls.Add(BrowseFile(_schema), 2, 3);
        table.Controls.Add(new Label { Text = "Base DBC layer:", AutoSize = true, Anchor = AnchorStyles.Left }, 0, 4);
        table.Controls.Add(_baseDbc, 1, 4); table.Controls.Add(Browse(_baseDbc, "Select the base DBC directory"), 2, 4);
        table.Controls.Add(new Label { Text = "Override DBC layer:", AutoSize = true, Anchor = AnchorStyles.Left }, 0, 5);
        table.Controls.Add(_overrideDbc, 1, 5); table.Controls.Add(Browse(_overrideDbc, "Select the Area52/override DBC directory"), 2, 5);
        ...
        table.Controls.Add(buttons, 0, 6); table.SetColumnSpan(buttons, 3); Controls.Add(table);
