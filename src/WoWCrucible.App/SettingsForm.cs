...
internal sealed class SettingsForm : Form
{
    ...
    {
        Text = "WoW Crucible Workspace"; Width = 850; Height = 465; StartPosition = FormStartPosition.CenterParent;
        FormBorderStyle = FormBorderStyle.FixedDialog; MaximizeBox = false; MinimizeBox = false;
        _core.Text = settings.CoreDbcPath; _coreSource.Text = settings.CoreSourcePath; _client.Text = settings.ClientDataPath; _clientExecutable.Text = settings.ClientExecutablePath; _schema.Text = settings.SchemaDefinitionPath;
        ...
        var table = new TableLayoutPanel { Dock = DockStyle.Fill, Padding = new(12), ColumnCount = 3, RowCount = 9 };
        ...
        table.Controls.Add(new Label { Text = "Core source (optional):", AutoSize = true, Anchor = AnchorStyles.Left }, 0, 2);
        table.Controls.Add(_coreSource, 1, 2); table.Controls.Add(Browse(_coreSource, "Select the AzerothCore or TrinityCore source checkout for exact DBC bindings"), 2, 2);
        table.Controls.Add(new Label { Text = "WoW client Data:", AutoSize = true, Anchor = AnchorStyles.Left }, 0, 3);
        table.Controls.Add(_client, 1, 3); table.Controls.Add(Browse(_client, "Select the WoW client Data folder"), 2, 3);
        table.Controls.Add(new Label { Text = "Client Wow.exe:", AutoSize = true, Anchor = AnchorStyles.Left }, 0, 4);
        table.Controls.Add(_clientExecutable, 1, 4); table.Controls.Add(BrowseExecutable(_clientExecutable), 2, 4);
        table.Controls.Add(new Label { Text = "Definition schema XML:", AutoSize = true, Anchor = AnchorStyles.Left }, 0, 5);
        table.Controls.Add(_schema, 1, 5); table.Controls.Add(BrowseFile(_schema), 2, 5);
        table.Controls.Add(new Label { Text = "Base DBC layer:", AutoSize = true, Anchor = AnchorStyles.Left }, 0, 6);
        table.Controls.Add(_baseDbc, 1, 6); table.Controls.Add(Browse(_baseDbc, "Select the base DBC directory"), 2, 6);
        table.Controls.Add(new Label { Text = "Override DBC layer:", AutoSize = true, Anchor = AnchorStyles.Left }, 0, 7);
        table.Controls.Add(_overrideDbc, 1, 7); table.Controls.Add(Browse(_overrideDbc, "Select the Area52/override DBC directory"), 2, 7);
        ...
        table.Controls.Add(buttons, 0, 8); table.SetColumnSpan(buttons, 3); Controls.Add(table);
        AcceptButton = buttons.Controls[0] as Button; CancelButton = buttons.Controls[1] as Button;
        FormClosing += (_, e) =>
        {
            if (DialogResult != DialogResult.OK) return;
            if (!ValidFolder(_core.Text, "server DBC", e) || !ValidFolder(_coreSource.Text, "core source", e) || !ValidFolder(_client.Text, "client Data", e) || !ValidFolder(_baseDbc.Text, "base DBC", e) || !ValidFolder(_overrideDbc.Text, "override DBC", e)) return;
            ...
            settings.CoreDbcPath = _core.Text.Trim(); settings.CoreSourcePath = _coreSource.Text.Trim(); settings.ClientDataPath = _client.Text.Trim(); settings.ClientExecutablePath = _clientExecutable.Text.Trim(); settings.SchemaDefinitionPath = _schema.Text.Trim();
