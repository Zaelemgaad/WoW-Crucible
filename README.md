...
1. Connect the landed same-window project allocator beyond full-item copy into spell, creature, gameobject, quest, race/class, recovery/fusion, and unified validation/change plans.
