...
var geometrySkin = new byte[162]; System.Text.Encoding.ASCII.GetBytes("SKIN").CopyTo(geometrySkin, 0); BitConverter.GetBytes((uint)3).CopyTo(geometrySkin, 4); BitConverter.GetBytes((uint)48).CopyTo(geometrySkin, 8); BitConverter.GetBytes((uint)6).CopyTo(geometrySkin, 12); BitConverter.GetBytes((uint)54).CopyTo(geometrySkin, 16); BitConverter.GetBytes((uint)2).CopyTo(geometrySkin, 28); BitConverter.GetBytes((uint)66).CopyTo(geometrySkin, 32);
