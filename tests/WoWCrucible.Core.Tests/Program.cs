...
if (Directory.Exists(desktopSourceRoot))
{
    ...
    if (!mapWorkspaceSource.Contains("Build terrain + placement scene", StringComparison.Ordinal) || !mapWorkspaceSource.Contains("Terrain + placement scene", StringComparison.Ordinal) ||
        ...
        !mapWorkspaceSource.Contains("UseScenePlacementPick", StringComparison.Ordinal) || !mapWorkspaceSource.Contains("Open placement controls", StringComparison.Ordinal) ||
        !mapSceneSource.Contains("Pick placement position", StringComparison.Ordinal) || !mapSceneSource.Contains("StatusChanged", StringComparison.Ordinal) || !mapSceneSource.Contains("MapScenePickingService.PickTerrain", StringComparison.Ordinal) || !mapSceneSource.Contains("pickMode ? scene.TerrainMinimum", StringComparison.Ordinal) || !mapSceneSource.Contains("new ControlAutomationPeer(this)", StringComparison.Ordinal) || !mapSceneSource.Contains("M2PreviewSceneService.MapObjectTransform", StringComparison.Ordinal) || !mapSceneSource.Contains("MCLY/MCAL terrain materials", StringComparison.Ordinal) ||
