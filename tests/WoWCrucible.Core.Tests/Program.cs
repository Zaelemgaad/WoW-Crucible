...
var geometrySkin = new byte[186]; System.Text.Encoding.ASCII.GetBytes("SKIN").CopyTo(geometrySkin, 0); BitConverter.GetBytes((uint)3).CopyTo(geometrySkin, 4); BitConverter.GetBytes((uint)48).CopyTo(geometrySkin, 8); BitConverter.GetBytes((uint)6).CopyTo(geometrySkin, 12); BitConverter.GetBytes((uint)54).CopyTo(geometrySkin, 16); BitConverter.GetBytes((uint)2).CopyTo(geometrySkin, 28); BitConverter.GetBytes((uint)66).CopyTo(geometrySkin, 32); BitConverter.GetBytes((uint)1).CopyTo(geometrySkin, 36); BitConverter.GetBytes((uint)162).CopyTo(geometrySkin, 40);
for (ushort index = 0; index < 3; index++) BitConverter.GetBytes(index).CopyTo(geometrySkin, 48 + index * 2);
for (ushort index = 0; index < 6; index++) BitConverter.GetBytes((ushort)(index % 3)).CopyTo(geometrySkin, 54 + index * 2);
BitConverter.GetBytes((ushort)0).CopyTo(geometrySkin, 66); BitConverter.GetBytes((ushort)3).CopyTo(geometrySkin, 72); BitConverter.GetBytes((ushort)0).CopyTo(geometrySkin, 74); BitConverter.GetBytes((ushort)3).CopyTo(geometrySkin, 76);
BitConverter.GetBytes((ushort)2).CopyTo(geometrySkin, 114); BitConverter.GetBytes((ushort)3).CopyTo(geometrySkin, 120); BitConverter.GetBytes((ushort)3).CopyTo(geometrySkin, 122); BitConverter.GetBytes((ushort)3).CopyTo(geometrySkin, 124);
geometrySkin[162] = 16; BitConverter.GetBytes((ushort)0).CopyTo(geometrySkin, 166); BitConverter.GetBytes((ushort)0).CopyTo(geometrySkin, 168); BitConverter.GetBytes((short)-1).CopyTo(geometrySkin, 170); BitConverter.GetBytes((ushort)1).CopyTo(geometrySkin, 176); BitConverter.GetBytes((ushort)0).CopyTo(geometrySkin, 178);
