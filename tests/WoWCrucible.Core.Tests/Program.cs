...
var legacyAddCombiner = M2PreviewGeometryService.DescribeCombiner(3, 2); var legacyMod2xCombiner = M2PreviewGeometryService.DescribeCombiner(0x74, 2); var explicitMod2x = M2PreviewGeometryService.DescribeCombiner(0x8000, 2); var explicitAdd = M2PreviewGeometryService.DescribeCombiner(0x8001, 2); var explicitAddAlphaAlpha = M2PreviewGeometryService.DescribeCombiner(0x8002, 2); var explicitModAddEnvironment = M2PreviewGeometryService.DescribeCombiner(0x8004, 2); var explicitAddPrimary = M2PreviewGeometryService.DescribeCombiner(0x8005, 2); var explicitModAdd = M2PreviewGeometryService.DescribeCombiner(0x8006, 2); var explicitEdgeFade = M2PreviewGeometryService.DescribeCombiner(0x8015, 2); var explicitOpaqueAlpha = M2PreviewGeometryService.DescribeCombiner(0x8017, 2); var unsupportedExplicit = M2PreviewGeometryService.DescribeCombiner(0x8007, 2); var unsupportedExplicitStageCount = M2PreviewGeometryService.DescribeCombiner(0x8001, 1);
