...
var legacyAddCombiner = M2PreviewGeometryService.DescribeCombiner(3, 2); var legacyMod2xCombiner = M2PreviewGeometryService.DescribeCombiner(0x74, 2); var explicitMod2x = M2PreviewGeometryService.DescribeCombiner(0x8000, 2); var explicitAdd = M2PreviewGeometryService.DescribeCombiner(0x8001, 2); var explicitModAdd = M2PreviewGeometryService.DescribeCombiner(0x8006, 2); var unsupportedExplicit = M2PreviewGeometryService.DescribeCombiner(0x8002, 2); var unsupportedExplicitStageCount = M2PreviewGeometryService.DescribeCombiner(0x8001, 1);
if (legacyAddCombiner.Name != "Opaque_Add" || !legacyAddCombiner.Supported || legacyAddCombiner.Exact || legacyMod2xCombiner.Name != "Mod_Mod2x" || legacyMod2xCombiner.Exact || !explicitMod2x.Supported || explicitMod2x.Exact || explicitMod2x.Kind != M2PreviewTextureCombinerKind.ExplicitOpaqueMod2xNaAlpha || !explicitAdd.Supported || explicitAdd.Kind != M2PreviewTextureCombinerKind.ExplicitOpaqueAddAlpha || !explicitModAdd.Supported || explicitModAdd.Kind != M2PreviewTextureCombinerKind.ExplicitModAddAlpha || unsupportedExplicit.Supported || unsupportedExplicitStageCount.Supported)
